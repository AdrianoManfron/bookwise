...
$validacao = Validacao::validar([
    ...
    'autor' => ['required'],
    'descricao' => ['required', 'min:30', 'max:500'],
...
$database->query("insert into livros ( titulo, autor, descricao, ano_de_lancamento, usuario_id, imagem ) values ( :titulo, :autor, :descricao, :ano_de_lancamento, :usuario_id, :imagem)",
            params: compact('titulo', 'autor', 'descricao', 'ano_de_lancamento', 'usuario_id', 'imagem')
);

flash()->push('mensage', 'Livro cadastrado com sucesso!');
